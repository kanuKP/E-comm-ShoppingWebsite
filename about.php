...
<div class="header" id="home">
	<div class="container">
		<ul>
		    <li> <a href="signin.php" ><i class="fa fa-unlock-alt" aria-hidden="true"></i> Sign In </a></li>
			<li> <a href="signup.php" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sign Up </a></li>
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					<li class="active menu__item"><a class="menu__link" href="homepage.php">Home <span class="sr-only">(current)</span></a></li>
			...
			<div class="agile_ab_w3ls_info">
				<div class="col-md-6 ab_pic_w3ls">
				 ...
				 <div class="col-md-6 ab_pic_w3ls_text_info">
					...
					<p>About Snapdeal – India’s Ultimate Online Shopping Site Snapdeal’s vision is to create India’s most reliable and frictionless commerce ecosystem that creates life-changing experiences for buyers and sellers.</p>
		...
		<div class="col-md-6 agileits_schedule_bottom_right">
			<div class="w3ls_schedule_bottom_right_grid">
				...
				<p>Suspendisse varius turpis efficitur erat laoreet dapibus. 
					Mauris sollicitudin scelerisque commodo.Nunc dapibus 
					mauris sed metus finibus posuere.</p>
